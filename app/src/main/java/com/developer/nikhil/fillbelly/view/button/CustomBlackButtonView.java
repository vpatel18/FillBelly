...
public class CustomBlackButtonView extends Button
{
    String typeFace = Constants.textlato_black;
    public CustomBlackButtonView(Context context)
    {
        super(context);
    ...
    public CustomBlackButtonView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public CustomBlackButtonView(Context context, AttributeSet attrs, int defStyle)
    {
