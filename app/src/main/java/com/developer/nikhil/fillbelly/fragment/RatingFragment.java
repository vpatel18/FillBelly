...
import com.developer.nikhil.fillbelly.adapter.RatingAdapter;
...
public class RatingFragment extends Fragment {
    ...
    private static final String TAG = "RatingFragment.class";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        /*for (int i = 0; i < 10; i++) {
            ...
            if (i/2 == 0) {
                bean.setTvHotelName("Kaizan");
                bean.setTvDetail("Italian, Indian, Dishes");
                bean.setTvRating("4.3/5");
            } else {
                bean.setTvHotelName("TGB");
                bean.setTvDetail("Italian, Mexican Dishes");
                bean.setTvRating("4.7/5");
            }
            hotellist.add(bean);
        }
    ...
    private void getHotelList() {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST,
                (Constants.BASE_URL + Constants.RATING),
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        Log.e("!_@@ getHotelList rating` Resp:>", "" + response);
                        // Hide ProgressDialog
                        hideProgressDialog();
                        try {
                            ...
                            ratingAdapter = new RatingAdapter(getActivity(), hotellist);
                            rvNearBy.setAdapter(ratingAdapter);
