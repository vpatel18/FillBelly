...
public class CustomLightButtonView extends Button {
    String typeFace = Constants.textlato_light;

    public CustomLightButtonView(Context context) {
        super(context);
    ...
    public CustomLightButtonView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomLightButtonView(Context context, AttributeSet attrs, int defStyle) {
