...
public class CustomBoldItalicButtonView extends Button
{
    String typeFace = Constants.textlato_bold_italic;
    public CustomBoldItalicButtonView(Context context)
    {
        super(context);
    ...
    public CustomBoldItalicButtonView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public CustomBoldItalicButtonView(Context context, AttributeSet attrs, int defStyle)
    {
