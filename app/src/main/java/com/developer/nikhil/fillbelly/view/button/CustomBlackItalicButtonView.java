...
public class CustomBlackItalicButtonView extends Button
{
	String typeFace = Constants.textlato_black_italic;
	public CustomBlackItalicButtonView(Context context)
	{
		super(context);
	...
	public CustomBlackItalicButtonView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	public CustomBlackItalicButtonView(Context context, AttributeSet attrs, int defStyle)
	{
