...
public class CustomLightItalicButtonView extends Button {
    String typeFace = Constants.textlato_light_italic;

    public CustomLightItalicButtonView(Context context) {
        super(context);
    ...
    public CustomLightItalicButtonView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public CustomLightItalicButtonView(Context context, AttributeSet attrs, int defStyle) {
